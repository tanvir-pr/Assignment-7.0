    ...
    return (
        <div>
            ...
            <div className='flex justify-between mb-6  mx-20'>
                <div></div>
                {/* <div className='text-2xl font-bold'>Available Players({selectiveProducts.length}/6)</div> */}
            ...
            {isActive.Available ? <Players handelSelectivePlayer={handelSelectivePlayer}></Players> :
                <Selected handleDelate={handleDelate} selectiveProducts={selectiveProducts}
                    handelSelectivePlayer={handelSelectivePlayer}
                    handleIsActiveState={handleIsActiveState}></Selected>}
